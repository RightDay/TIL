...
* # 사원수(Quaternion)
  ...
  * 3차원 그래픽에서 회전을 표현할 때, 행렬 대신 사용하는 수학적 개념으로 4개의 값으로 이루어진 복소수(Complex Number) 체계이다.
    ...
    * 복소수(Complex Number) : 실수부와 허수부의 합으로 구성된 수이다.
  ...
  *  ### D3DXQUATERNION
		...
		* ```cpp
	      D3DXQUATERNION q;
	      D3DXQuaternionIdentity(q);	//단위 쿼터니언(x, y, z, w) = (0, 0, 0, 1) 반환
	  ...
	  * 정규화한 쿼터니언의 각 성분이 축/각도의 회전에 어떻게 관계하고 있는지 나타낸다.
