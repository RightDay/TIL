...
* 1°는 라디안으로 180/π이고, 1 rad는 도 단위로 π/180이다.
...
* 직각 삼각형에 대한 각의 크기를 삼각비로 나타내는 함수이다.
...
* 임의의 점 P를 통해 빗변의 길이가 반지름의 길이인 직각삼각형을 그릴 수 있다.

* P(x, y)는 사인과 코사인 정의에 의해 cosθ = x/1, sinθ = y/1이 된다. 따라서 **x = cosθ, y = sinθ**이다.

* 단위원을 사용하면 사인과 코사인 값을 90°의 배수에 대해 쉽게 기억할 수 있다.

  (90°에서 단위원 위의 점의 자표가 (0, 1)이 므로,  cos90°=0, sin90° = 1이 된다.)
