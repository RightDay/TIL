...
![synchronization_issue_code](D:\Dev\TIL\ComputerScience\image\synchronization_issue_code.png)
...
![synchronization_issue](D:\Dev\TIL\ComputerScience\image\synchronization_issue.png)
...
![Mutual_exclusion_code](D:\Dev\TIL\ComputerScience\image\Mutual_exclusion_code.png)
...
![semaphore](D:\Dev\TIL\ComputerScience\image\semaphore.png)
...
![busy_waiting](D:\Dev\TIL\ComputerScience\image\busy_waiting.png)
...
![ready_queue](D:\Dev\TIL\ComputerScience\image\ready_queue.png)



wakeup() 함수를 통해 대기 큐에 있는 프로세스를 재실행함으로 의미 없는 CPU 부하를 제거할 수 있다.

![wakeup](D:\Dev\TIL\ComputerScience\image\wakeup.png)
