...
![Program_Processing_Process](./images/Program_Processing_Process.png)

- IDE (Integrated Development Environment, 통합 개발 환경)에서 고급언어프로그램을 사용하여 작성

  CPU의 제조사가 무엇인지 등등을 신경쓸 필요없이 처리해야할 문제를 중심으로 작성하면 된다.

![software_development_paradigm](./images/software_development_paradigm.png)
...
![Webshark](./images/Webshark.png)

- NOS : New technology Operating System
- Wireshark : 정보가 탈취당하고 있는지도 확인할 수 있다.
